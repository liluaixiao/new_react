 ...
 * ```
 */
class VerticalViewPagerAndroid extends React.Component {
    props: {
        initialPage?: number,
...
var NativeAndroidViewPager = requireNativeComponent('VerticalAndroidViewPager', VerticalViewPagerAndroid);

module.exports = VerticalViewPagerAndroid;
